...
HomeCtrl.$inject = ['$scope', '$http', 'homeService', 'localStorageService', '$location', 'toaster'];

function HomeCtrl($scope, $http, homeService, localStorageService, $location, toaster) {
